...
export function GridBackground({
  ...
  return (
    <div 
      ...
      style={{
        backgroundColor: 'rgba(33, 156, 222, 1)',
        backgroundImage: `
    ...
    >
      ...
      <div className="relative z-20 text-center max-w-7xl">
        ...
        {description && (
          <p className='text-md md:text-xl mt-5 text-gray-300 max-w-2xl mx-auto'>{description}</p>
        )}
        ...
        {showAvailability && (
          <div className="available-now text-[#20bb5a] text-sm flex items-center justify-center mt-5 font-medium">
